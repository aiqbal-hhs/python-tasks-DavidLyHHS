...
def menu():
  ...
  color.write("\nType: \n", "SYNC")
  color.write("'1' to view menu\n", "SYNC")
  color.write("'2' to view pizza options and prices\n", "SYNC")
  color.write("'3' to order pizza\n", "SYNC")
  color.write("'4' to view order\n", "SYNC")
  color.write("'5' to cancel ordering\n", "SYNC")
...
while repeat == True:
  ...
  if option == "1":
    ...
    print("Thanks for buying from Henderson Pizza Palace!")
    repeat = False
  else:
